...
But when you just want to **see the signal in real time** — check electrode contact, verify muscle activation, monitor during experiments — all those settings get in the way.
